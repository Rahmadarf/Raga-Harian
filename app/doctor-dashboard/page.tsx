...
import { Bell, Users, MessageSquare, TrendingUp, Calendar, Clock, Award, FileText, Activity, LayoutGrid, Users as UsersIcon } from "lucide-react";
...
export default function DoctorDashboard() {
    ...
    // Unread count from notification bell
            ...
            {activeView === 'dashboard' ? (
                ...
                <div className="space-y-6">
                    ...
                    <Banner
                        ...
                        subtext={stats.unreadMessages > 0 ? `${stats.unreadMessages} pesan belum dibaca` : "Semua pesan sudah dibaca"}
                        chips={[
                ...
                // Chat View
                <div className="grid gap-5" style={{ gridTemplateColumns: '350px 1fr 320px', height: 'calc(100vh - 180px)' }}>
                    {/* Patients List */}
                    <div>
                        <DoctorPatientsList
                            onSelectPatient={handleSelectPatient}
