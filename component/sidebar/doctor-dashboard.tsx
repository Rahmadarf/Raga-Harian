...
const navItems = [
    ...
    { id: "chat", href: "/doctor-dashboard/chat", icon: MessageSquare, label: "Pesan Pasien" },
    { id: "patients", href: "/doctor-dashboard/pasien", icon: Users, label: "Daftar Pasien" },
];
    ...
    useEffect(() => {
        const fetchUnreadCount = async () => {
            try {
                ...
                if (data.patients) {
                    const unread = data.patients.reduce((sum: number, p: any) => sum + (p.unreadMessages || 0), 0);
